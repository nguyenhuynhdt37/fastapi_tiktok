...
class TblUser(Base):
    ...
    role: Mapped[Optional['TblRole']] = relationship('TblRole', back_populates='tblUser')
    tblFollower: Mapped[List['TblFollower']] = relationship('TblFollower', foreign_keys='[TblFollower.follower_id]', back_populates='follower')
    video: Mapped[List['Video']] = relationship('Video', back_populates='owner')
    view_profile: Mapped[List['ViewProfile']] = relationship('ViewProfile', foreign_keys='[ViewProfile.viewer_id]', back_populates='viewer')
    comment: Mapped[List['Comment']] = relationship('Comment', back_populates='user')
    react_comment: Mapped[List['ReactComment']] = relationship('ReactComment', back_populates='user')


class TblFollower(TblUser):
    ...
    follower: Mapped[Optional['TblUser']] = relationship('TblUser', foreign_keys=[follower_id], back_populates='tblFollower')
...
class Video(Base):
    ...
    hashtag: Mapped[List['Hashtag']] = relationship('Hashtag', secondary='video_hastag', back_populates='video')
    owner: Mapped[Optional['TblUser']] = relationship('TblUser', back_populates='video')
    comment: Mapped[List['Comment']] = relationship('Comment', back_populates='video')


class ViewProfile(TblUser):
    ...
    viewer: Mapped[Optional['TblUser']] = relationship('TblUser', foreign_keys=[viewer_id], back_populates='view_profile')
...
class Comment(Base):
    ...
    user: Mapped[Optional['TblUser']] = relationship('TblUser', back_populates='comment')
    video: Mapped[Optional['Video']] = relationship('Video', back_populates='comment')
    react_comment: Mapped[List['ReactComment']] = relationship('ReactComment', back_populates='comment')
...
class ReactComment(Base):
    ...
    comment: Mapped[Optional['Comment']] = relationship('Comment', back_populates='react_comment')
    user: Mapped[Optional['TblUser']] = relationship('TblUser', back_populates='react_comment')
